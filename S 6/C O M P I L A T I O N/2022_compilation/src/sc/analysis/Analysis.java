...
public interface Analysis extends Switch
{
    ...
    void caseAInstnonnullInstr(AInstnonnullInstr node);
    ...
    void caseASanssinonInstopetern(ASanssinonInstopetern node);
    void caseAAvecsinonInstopetern(AAvecsinonInstopetern node);
    void caseAInstnonnull(AInstnonnull node);
    ...
    void caseANonnullExp6(ANonnullExp6 node);
    void caseAExp7Exp6(AExp7Exp6 node);
    void caseANombreExp7(ANombreExp7 node);
    void caseAAppelfctExp7(AAppelfctExp7 node);
    void caseAVarExp7(AVarExp7 node);
    void caseAParenthesesExp7(AParenthesesExp7 node);
    ...
    void caseTNonnull(TNonnull node);
