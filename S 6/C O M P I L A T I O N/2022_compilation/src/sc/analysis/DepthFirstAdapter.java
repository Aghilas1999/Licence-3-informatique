...
public class DepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inAInstnonnullInstr(AInstnonnullInstr node)
    {
        defaultIn(node);
    }

    public void outAInstnonnullInstr(AInstnonnullInstr node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAInstnonnullInstr(AInstnonnullInstr node)
    {
        inAInstnonnullInstr(node);
        if(node.getInstnonnull() != null)
        {
            node.getInstnonnull().apply(this);
        }
        outAInstnonnullInstr(node);
    }
    ...
    public void inASanssinonInstopetern(ASanssinonInstopetern node)
    {
        defaultIn(node);
    }

    public void outASanssinonInstopetern(ASanssinonInstopetern node)
    {
        defaultOut(node);
    }

    @Override
    public void caseASanssinonInstopetern(ASanssinonInstopetern node)
    {
        inASanssinonInstopetern(node);
        if(node.getSi() != null)
        {
            node.getSi().apply(this);
        }
        ...
        if(node.getNonnull() != null)
        {
            node.getNonnull().apply(this);
        }
        if(node.getAlors() != null)
        {
            node.getAlors().apply(this);
        ...
        if(node.getInstopetern() != null)
        {
            node.getInstopetern().apply(this);
        }
        outASanssinonInstopetern(node);
    }

    public void inAAvecsinonInstopetern(AAvecsinonInstopetern node)
    {
        defaultIn(node);
    }

    public void outAAvecsinonInstopetern(AAvecsinonInstopetern node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAvecsinonInstopetern(AAvecsinonInstopetern node)
    {
        inAAvecsinonInstopetern(node);
        if(node.getSi() != null)
        {
            node.getSi().apply(this);
        }
        ...
        outAAvecsinonInstopetern(node);
    }

    public void inAInstnonnull(AInstnonnull node)
    {
        defaultIn(node);
    }

    public void outAInstnonnull(AInstnonnull node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAInstnonnull(AInstnonnull node)
    {
        inAInstnonnull(node);
        if(node.getNonnull() != null)
        {
    ...
    public void inANonnullExp6(ANonnullExp6 node)
    {
        defaultIn(node);
    }

    public void outANonnullExp6(ANonnullExp6 node)
    {
        defaultOut(node);
    }
    ...
    public void inAAppelfctExp7(AAppelfctExp7 node)
    {
        defaultIn(node);
    }

    public void outAAppelfctExp7(AAppelfctExp7 node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAAppelfctExp7(AAppelfctExp7 node)
    {
        inAAppelfctExp7(node);
        if(node.getAppelfct() != null)
        {
            node.getAppelfct().apply(this);
        }
        outAAppelfctExp7(node);
    }
    ...
    public void inAParenthesesExp7(AParenthesesExp7 node)
    {
        defaultIn(node);
    }

    public void outAParenthesesExp7(AParenthesesExp7 node)
    {
        defaultOut(node);
    }

    @Override
    public void caseAParenthesesExp7(AParenthesesExp7 node)
    {
        inAParenthesesExp7(node);
        if(node.getParentheseOuvrante() != null)
        {
            node.getParentheseOuvrante().apply(this);
        }
